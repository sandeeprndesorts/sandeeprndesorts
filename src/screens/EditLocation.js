        ...
        <BaseView
            ...
            <View style={{ flex: 1, paddingVertical: height(1) }}>
                ...
                <View style={{ flex: 1, alignItems: 'center' }}>
                    <Text style={{ fontSize: fontSize(5), fontFamily: FONTS.bold }}>Edit Location</Text>
                </View>
                ...
                <View style={{ flex: 1, marginVertical: height(2) }}>
                    ...
                    <View style={{ height: height(90), flexDirection: 'column' }}>
                        ...
                        <View style={{ height: height(10), alignSelf: 'center', justifyContent: 'center', width: width(100), position: 'absolute', top: height(52) }}>

                            <Pressable>
                                <View style={{
                                    height: height(6.5), width: width(90), borderRadius: width(3), backgroundColor: '#FFFFFF', flexDirection: 'row', alignSelf: 'center', marginBottom: height(1)
                                }}>

                                    <Image source={require('../assets/icons/location.png')} resizeMode={'contain'} style={{ marginStart: width(5), alignSelf: 'center', justifyContent: 'center', height: height(5), width: width(5) }} />

                                    <TextInput
                                        style={{ fontSize: fontSize(4), color: 'black', marginHorizontal: width(3), flex: 1 }}
                                    ...
                                    <Image source={require('../assets/icons/search.png')} resizeMode={'contain'} style={{ marginHorizontal: width(5), alignSelf: 'center', justifyContent: 'center' }} />
