...
export default function EditDrink() {
    ...
    const [drink1, setDrink1] = useState("beer")
    const [drink2, setDrink2] = useState("wine")
    ...
    return (
        <BaseView
            ...
            <View style={{ flex: 1, paddingVertical: height(1) }}>
                ...
                <Image source={require('../assets/icons/drink.png')} resizeMode={'contain'} style={{ width: width(100), height: height(20), marginVertical: height(2) }} resizeMode={'contain'} />

                <View style={{ flex: 1, alignItems: 'center' ,marginVertical: height(3) }}>
                    <Text style={{ fontSize: fontSize(5), fontFamily: FONTS.bold }}>Edit Your Favorite Drinks</Text>
                    {/* <Text style={{ fontSize: fontSize(5), fontFamily: FONTS.bold }}>drink! Let others know</Text> */}
                    {/* <Text style={{ fontSize: fontSize(5), fontFamily: FONTS.bold }}>what drink to send your</Text>
                    <Text style={{ fontSize: fontSize(5), fontFamily: FONTS.bold }}>way and vice versa!</Text>

                    <Text style={{ fontSize: fontSize(3.2), marginVertical: height(3), fontWeight: '500' }}>Your favorite drink choices:</Text> */}
                </View>


                <View style={{ flex: 1, marginHorizontal: width(10), flexDirection: 'row', marginVertical: height(3) }}>
                    ...
                    <View style={{ marginTop: -50, width: width(80) }}>
                        <AppTextInput
                            ...
                            blurOnSubmit={false}
                            onSubmitEditing={() => { }}
                            textInputStyle={{ marginHorizontal: width(3) }}
